...
LookupEntry keywordLookup[] = {
    ...
    {.character="int8",              .token={.type=TOKEN_LITERAL,       .value={.Literal={LITERAL_VALUE_INT8}}}},
    {.character="int16",             .token={.type=TOKEN_LITERAL,       .value={.Literal={LITERAL_VALUE_INT16}}}},
    {.character="int32",             .token={.type=TOKEN_LITERAL,       .value={.Literal={LITERAL_VALUE_INT32}}}},
    {.character="int64",             .token={.type=TOKEN_LITERAL,       .value={.Literal={LITERAL_VALUE_INT64}}}},
    {.character="float8",            .token={.type=TOKEN_LITERAL,       .value={.Literal={LITERAL_VALUE_FLOAT8}}}},
    {.character="float16",           .token={.type=TOKEN_LITERAL,       .value={.Literal={LITERAL_VALUE_FLOAT8}}}},
    {.character="float32",           .token={.type=TOKEN_LITERAL,       .value={.Literal={LITERAL_VALUE_FLOAT8}}}},
    {.character="float64",           .token={.type=TOKEN_LITERAL,       .value={.Literal={LITERAL_VALUE_FLOAT8}}}},
    {.character="unsign",            .token={.type=TOKEN_LITERAL,       .value={.Literal={LITERAL_VALUE_LOGIC_UNSIGNED}}}},
